                                ...
                                <div class="row">
                                    ...
                                    @if(auth()->user()->can($permissions['create']))
                                     <div class="col-auto align-self-center">
                                        <a class=" btn btn-sm btn-primary webadmin-open-ajax-popup" title="Create Employ" href="{{route($route.'.create')}}" role="button"><i class="fas fa-plus mr-2"></i>Create New</a>
                                    </div>
                                    @endif
                                </div><!--end row-->                                                              
                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="table-width-120">Employ Name</th>
...
@section('footer')
    <script>
        var my_columns = [
            ...
            {data: null, name: 'id'},
            {data: 'employ_name', name: 'employ_name'},
        ...
        var adminValidate = function(){
            $('#InputFrm').validate({
                ...
                messages: {
                    "employ_name": "Employ name cannot be blank",
                },
            });
        };
    </script>
