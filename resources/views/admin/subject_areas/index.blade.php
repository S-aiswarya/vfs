                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">All Subject Areas</h4>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item active">All Subject Areas</li>
                                        </ol>
                                    </div><!--end col-->
                                    @if(auth()->user()->can($permissions['create']))
                                     <div class="col-auto align-self-center">
                                        <a class=" btn btn-sm btn-primary webadmin-open-ajax-popup" title="Create Subject Area" href="{{route($route.'.create')}}" role="button"><i class="fas fa-plus mr-2"></i>Create New</a>
                                    </div>
                                    @endif
                                </div><!--end row-->                                                              
                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="table-width-10">Image</th>
                                            <th class="table-width-120">Course Level</th>
...
@section('footer')
    <script>
        var my_columns = [
            ...
            {data: 'course_level', name: 'course_levels.name'},
            {data: 'name', name: 'name'},
        ...
        var adminValidate = function(){
            $('#InputFrm').validate({
                ...
                messages: {
                    "name": "Subject area name cannot be blank",
                    "course_level_id": "Course level cannot be blank"
                },
            });
        };
    </script>
