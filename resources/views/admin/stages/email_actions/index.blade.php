                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">All email actions of {{$stage->name}}</h4>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item"><a href="{{route('admin.stages.index')}}">All Stages</a></li>
                                            <li class="breadcrumb-item active">Email actions of {{$stage->name}}</li>
                                        </ol>
                                    </div><!--end col-->
                                    @if(auth()->user()->can($permissions['create']))
                                     <div class="col-auto align-self-center">
                                        <a class=" btn btn-sm btn-primary webadmin-open-ajax-popup" title="Create email action for {{$stage->name}}" href="{{route($route.'.create', [$stage->id])}}" role="button"><i class="fas fa-plus mr-2"></i>Create New</a>
                                    </div>
                                    @endif
                                </div><!--end row-->                                                              
                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="table-width-120">Email Template</th>
                                            <th class="table-width-120">Send To</th>
                                            <th class="table-width-120">CC To</th>
...
@section('footer')
    <script>
        var my_columns = [
            ...
            {data: null, name: 'id'},
            {data: 'email_template', name: 'email_templates.name'},
        ...
        var adminValidate = function(){
            $('#InputFrm').validate({
                ...
                messages: {
                    "email_template_id": "Email template cannot be blank",
                    "send_to": "Send to cannot be blank",
                },
            });
        };
    </script>
