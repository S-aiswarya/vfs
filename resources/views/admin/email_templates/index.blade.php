                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">All Email Templates</li>
                                        </ol>
                                    </div><!--end col-->
                                    @if(auth()->user()->can($permissions['create']))
                                     <div class="col-auto align-self-center">
                                        <a class=" btn btn-sm btn-primary webadmin-open-ajax-popup" title="Create Email Template" href="{{route($route.'.create')}}" role="button"><i class="fas fa-plus mr-2"></i>Create New</a>
                                    </div>
                                    @endif
                                </div><!--end row-->                                                              
        ...
        var adminValidate = function(){
            $('#InputFrm').validate({
                ...
                messages: {
                    ...
                    "subject": "Mail Subject cannot be blank",
                    "body": "Mail Body cannot be blank",
                },
            });
        };

        $(function(){
            $(document).on('click', '#param-btn', function(){
                $('#params-list').toggle();
            })
        })
    </script>
