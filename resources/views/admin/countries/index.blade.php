                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">All Countries</h4>
                                        <ol class="breadcrumb">
                                    ...
                                    @if(auth()->user()->can($permissions['create']))
                                     <div class="col-auto align-self-center">
                                        <a class=" btn btn-sm btn-primary webadmin-open-ajax-popup" title="Create Country" href="{{route($route.'.create')}}" role="button"><i class="fas fa-plus mr-2"></i>Create New</a>
                                    </div>
                                    @endif
                                </div><!--end row-->                                                              
    ...
    <script>
        ...
        var adminValidate = function(){
            $('#InputFrm').validate({
                ...
                messages: {
                    "name": "Country name cannot be blank",
                },
            });
        };
    </script>
