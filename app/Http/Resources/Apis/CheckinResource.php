...
class CheckinResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return[
         ...
         'mode' =>$this->mode,
         'informed_to' =>$this->informed_to,
         'time_deposited' =>$this->time_deposited,
         'guard' =>$this->guard,
         'key_box' =>$this->key_box,
         'key_number' =>$this->key_number,
         'name_of_staff' =>$this->name_of_staff,
         'staff_one_name_check_in' =>$this->staff_one_name_check_in,
         'staff_two_name_check_in' =>$this->staff_two_name_check_in,
         'staff_one_name_check_out' =>$this->staff_one_name_check_out,
         'staff_two_name_check_out' =>$this->staff_two_name_check_out,
         ...
         'qty' =>$this->qty,
         'If_returnable_expected_date_of_return' =>$this->If_returnable_expected_date_of_return,
        'full_name_and_address_of_recipient' =>$this->full_name_and_address_of_recipient,
         ...
         'name_of_the_visitor' =>$this->name_of_the_visitor,
         'business_address_of_visitor' =>$this->business_address_of_visitor,
         'national_id_type' =>$this->national_id_type,
         'whom_to_visit' =>$this->whom_to_visit,
         'purpose_of_visit' =>$this->purpose_of_visit,
         'visitor_pass_no' =>$this->visitor_pass_no,
         'signature_of_visitor' =>$this->signature_of_visitor,
         'medium_of_training' =>$this->medium_of_training,
